...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--fineWidthSize', type=int, default=512, help='then crop to this size')
		self.parser.add_argument('--fineheightSize', type=int, default=512, help='then crop to this size')
		self.parser.add_argument('--input_nc', type=int, default=3, help='# of input image channels')
		self.parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels')
		self.parser.add_argument('--ngf', type=int, default=64, help='# of gen filters in first conv layer')
		self.parser.add_argument('--ndf', type=int, default=64, help='# of discrim filters in first conv layer')
		self.parser.add_argument('--which_model_netD', type=str, default='basic', help='selects model to use for netD')
		self.parser.add_argument('--which_model_netG', type=str, default='RankAttentionDeblureNet', help='selects model to use for netG')
		...
		self.parser.add_argument('--gan_type', type=str, default='ragan-ls', help='wgan-gp : Wasserstein GAN with Gradient Penalty, lsgan : Least Sqaures GAN, gan : Vanilla GAN')
		...
		self.parser.add_argument('--display_winsize', type=int, default=352,  help='display window size')
