...
class RelativisticDiscLossLS(nn.Module):
    ...
    def __init__(self):
        ...
        self.fake_pool = ImagePool(8)  # create image buffer to store previously generated images
        self.real_pool = ImagePool(8)
